...
from uvnet.models import Triplet
...
if args.dataset == "solidletters":
    ...
    train_data.generate_negative_samples()
    val_data.generate_negative_samples()
...
model = Triplet(out_emb_dim=args.out_dim, loss=args.loss)
