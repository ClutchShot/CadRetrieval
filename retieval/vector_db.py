...
class VectorDatabase:
    def __init__(self, db_folder: str, db_name: str, dimension: int, metric='L2'):
        """
    ...
    def add_vectors(self, 
        ...
        if len(vectors) != len(names) or len(vectors) != len(labels):
            raise ValueError("Vectors, names, and labels must have same length")
    ...
    def get_vectors_by_label(self, label: int) -> List[Dict[str, Any]]:
        pass
...
#     db.add_vectors(vectors, names, labels)
#     size_two = db.get_vector_count()
#     db.add_vectors(vectors, names, labels)
#     size_three = db.get_vector_count()
...
#     # Get all vectors with specific label
#     print("\nAll label 2 vectors:")
#     print(db.get_vectors_by_label(2))

#     # Get all unique labels
#     print("\nAll labels in database:")
#     print(db.get_all_labels())